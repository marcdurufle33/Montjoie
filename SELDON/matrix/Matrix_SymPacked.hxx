...
namespace Seldon
{
  ...
  public:
    ...
    virtual void GetDenseRow(int i, Vector<T>& row) const;
    virtual void GetDenseCol(int i, Vector<T>& col) const;
    virtual void SetDenseRow(int i, const Vector<T>& row);
    virtual void SetDenseCol(int i, const Vector<T>& col);
  ...
  public:
    ...
    Matrix(const Matrix<T, Prop, ColSymPacked, Allocator>& A) = default;
  ...
  public:
    Matrix();
    explicit Matrix(int i, int j = 0);
    Matrix(const Matrix<T, Prop, RowSymPacked, Allocator>& A) = default;
