...
namespace Seldon
{
  ...
  //! sets the stored entries to zero
  template <class T>
  void VirtualMatrix<T>::Zero()
  {
    // this method should be overloaded
    // if not overloaded, an exception is raised:
    throw Undefined("Zero", "Not implemented"); 
  }


  //! Sets x to element (i, j) of the matrix
  template <class T>
  void VirtualMatrix<T>::SetEntry(int i, int j, const T& x)
  {
    // this method should be overloaded in sparse matrices
    // if not overloaded, an exception is raised:
    throw Undefined("SetEntry", "Not implemented");
  }
  ...
  //! Adds values to several non-zero entries of a sparse matrix.
  template <class T>
  void VirtualMatrix<T>::AddInteractionColumn(int, int, const Vector<int>&,
					      const Vector<T>& val, bool sorted)
  {
    // this method should be overloaded in sparse matrices
    // if not overloaded, an exception is raised:
    throw Undefined("AddInteractionColumn", "Not implemented");
  }
  ...
  template <class T>
  size_t VirtualMatrix<T>::GetMemorySize() const
  {
    // this method should be overloaded
    // if not overloaded, an exception is raised:
  ...
  //! extracts the row i as a sparse vector
  template <class T>
  inline void VirtualMatrix<T>::GetSparseRow(int i, Vector<T, VectSparse>& row) const
  {
    // this method should be overloaded
    // if not overloaded, an exception is raised:
    throw Undefined("GetSparseRow", "Not implemented");
  }
  

  //! extracts the row i as a dense vector
  template <class T>
  inline void VirtualMatrix<T>::GetDenseRow(int i, Vector<T>& row) const
  {
    // this method should be overloaded
    // if not overloaded, an exception is raised:
    throw Undefined("GetDenseRow", "Not implemented");
  }


  //! extracts the column i as a dense vector
  template <class T>
  inline void VirtualMatrix<T>::GetDenseCol(int i, Vector<T>& row) const
  {
    // this method should be overloaded
    // if not overloaded, an exception is raised:
    throw Undefined("GetDenseCol", "Not implemented");
  }


  //! sets the row i
  template <class T>
  inline void VirtualMatrix<T>::SetDenseRow(int i, const Vector<T>& row)
  {
    // this method should be overloaded
    // if not overloaded, an exception is raised:
    throw Undefined("SetDenseRow", "Not implemented");
  }


  //! sets the column i
  template <class T>
  inline void VirtualMatrix<T>::SetDenseCol(int i, const Vector<T>& row)
  {
    // this method should be overloaded
    // if not overloaded, an exception is raised:
    throw Undefined("SetDenseCol", "Not implemented");
  }
  

  //! Applies S.O.R method to solve A x = r.
  template<class T> void VirtualMatrix<T>
  ::ApplySor(const SeldonTranspose&, Vector<Treal>& x, const Vector<Treal>& r,
  ...
  template<class T> void VirtualMatrix<T>
  ::ApplySor(const SeldonTranspose&, Vector<Tcplx>& x, const Vector<Tcplx>& r,
	     const typename ClassComplexType<T>::Treal& omega,
	     int nb_iter, int stage_ssor) const
  {
  ...
  template<class T> bool VirtualMatrix<T>::IsSparse() const
  {
    return false;
  }
