...
namespace Seldon
{
  ...
  */
  template <class T, class Prop, class Storage, class Allocator>
  inline long Matrix_ComplexSparse<T, Prop, Storage, Allocator>::GetNonZeros() const
  {
  ...
  */
  template <class T, class Prop, class Storage, class Allocator>
  inline long Matrix_ComplexSparse<T, Prop, Storage, Allocator>::GetDataSize() const
  {
    return real_nz_ + imag_nz_;
  }
  ...
  */
  template <class T, class Prop, class Storage, class Allocator>
  inline long* Matrix_ComplexSparse<T, Prop, Storage, Allocator>::GetRealPtr() const
  {
    return real_ptr_;
  }
  ...
  */
  template <class T, class Prop, class Storage, class Allocator>
  inline long* Matrix_ComplexSparse<T, Prop, Storage, Allocator>::GetImagPtr() const
  {
    return imag_ptr_;
  }
  ...
  */
  template <class T, class Prop, class Storage, class Allocator>
  inline long Matrix_ComplexSparse<T, Prop, Storage, Allocator>
