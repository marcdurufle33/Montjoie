...
or basename($_SERVER['REQUEST_URI'], ".php") == "distributed_vector"
or basename($_SERVER['REQUEST_URI'], ".php") == "functions_vector")
{
  ...
  echo '</li>';
  echo '<li class="jelly">';
  HL($file, "distributed_vector", "Distributed Vectors");
  echo '</li>';
  echo '<li class="jelly">';
...
or basename($_SERVER['REQUEST_URI'], ".php") == "distributed_matrix"
or basename($_SERVER['REQUEST_URI'], ".php") == "matrix_miscellaneous")
{
  ...
  echo '</li>';
  echo '<li class="jelly">';
  HL($file, "distributed_matrix", "Distributed Matrices");
  echo '</li>';
  echo '<li class="jelly">';
