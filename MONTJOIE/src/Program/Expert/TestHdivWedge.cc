...
int main(int argc, char **argv) 
{
  ...
  WedgeHdivHpFirstFamily test_elt;
  //WedgeHcurlHpFirstFamily test_elt;
  //WedgeHcurlFirstFamily test_elt;
  ...
  // on recupere une formule de quadrature d'ordre max(r, rf) + 1 pour la Wedgee
  VectR3 points3d;
