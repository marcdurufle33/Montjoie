...
int main(int argc, char **argv) 
{
  ...
  // on construit d'abord PyramidHcurlOther
  PyramidHcurlOther test_elt;
  //PyramidHcurlHpFirstFamily test_elt;
  //PyramidHcurlFirstFamily test_elt;
  ...
  PyramidQuadrature::ConstructQuadrature(max(r, rf) + 1, points3d, weights3d, points1d_z, weights1d_z, 
                                         PyramidQuadrature::QUADRATURE_JACOBI2);
  ...
  PyramidHcurlFirstFamily first_elt;
  ...
  PyramidHcurlOptimalFirstFamily opt_elt;
