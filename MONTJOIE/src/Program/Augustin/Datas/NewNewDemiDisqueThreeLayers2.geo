...
Transfinite Line {11, 14, 10, 13, 17, 18} =  3;
Transfinite Line {-9, -12} =  4 Using Progression 3;

Transfinite Line {1,2,3,4,5,6,7,8, 15, 16} = 9;
...
Curve Loop(7) = {7, 8};
Plane Surface(7) = {7};
Curve Loop(8) = {17, 15, -18, -1};
Plane Surface(8) = {8};
Curve Loop(9) = {17, -16, -18, 2};
Plane Surface(9) = {9};
