...
class ModeEsPoly1DirichletEigenProblem : public PolynomialSparseEigenProblem<Complex_wp, DistributedMatrix<Complex_wp, General, ArrayRowSparse>, DistributedMatrix<Complex_wp, General, ArrayRowSparse>>
{
  ...
  Vector<Matrix<Complexe, Prop, Storage> > &vec_Mh, &vec_M1h, &vec_M2h, &vec_Mr2h, &vec_Rih, &vec_Sih, &vec_Ti1h, &vec_Ti2h, &vec_Tj1h, &vec_Tj2h, &vec_Di1h, &vec_Di2h;
