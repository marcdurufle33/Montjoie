...
class ModeEsNonLinear_Dk_DirichletEigenProblem : public NonLinearEigenProblem_Base<Complex_wp>
{
...
public:
  ...
  void ExtractDirichletAuxVariable(const VectComplex_wp& EHdir, const int& ref, VectComplex_wp& E3, VectComplex_wp& H3, VectComplex_wp& Fref, VectComplex_wp& Gref);
  void ExpandDirichletAuxVariable(const int& ref, const VectComplex_wp& E3, const VectComplex_wp& H3, const VectComplex_wp& Fref, const VectComplex_wp& Gref, VectComplex_wp& EHdir);
