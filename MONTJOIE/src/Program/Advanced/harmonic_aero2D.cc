  ...
  if (argc > 1)
    {
      ...
      if (type_equation == "HARMONIC_LEE")
        {
          EllipticProblem<HarmonicLinearizedEulerEquation<Dimension2> > Vars;
        ...
        {
	  EllipticProblem<HarmonicAeroEquation<Dimension2> > Vars;
	  if (Vars.GetRankProcMode() == 0)
	    cout<<"Hyperbolic Solver with DG Lobatto quadrilaterals"<<endl; 
