...
void RunAll(GenericPb& scheme, InputVariablesWaterWaves& vars, const string& input_file)
{
  ...
  if (vars.type_formulation == vars.SPECTRAL)
    {
      ...
      TimeSpectralScheme1D<KdvEquationSpectral> scheme;
      RunAll(scheme, vars, input_file);
    }
