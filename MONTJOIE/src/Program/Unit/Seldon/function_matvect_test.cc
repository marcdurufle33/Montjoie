                     ...
                     GhostIf<triang>& triang_form, bool low)
{
  ...
  A.MltAddVector(alpha, x, zero, y);
  MltTest(A, x, z);
  Mlt(alpha, z);
  
  if (!EqualVector(y, z))
    {
      cout << "MltAddVector incorrect" << endl;
      abort();
    }  
  ...
  Copy(w, y);
  A.MltAddVector(alpha, SeldonNoTrans, x, beta, y);
                        ...
                        bool low)
{
  ...
  Copy(wc, yc);
  A.MltAddVector(alphac, xc, betac, yc);
  ...
  A.MltVector(SeldonNoTrans, xc, yc);
  ...
  Copy(wc, yc);
  A.MltAddVector(alphac, SeldonNoTrans, xc, betac, yc);
  ...
  Copy(wc, yc);
  A.MltAddVector(alphac, SeldonTrans, xc, betac, yc);
  ...
  A.MltVector(SeldonConjTrans, xc, yc);
  MltConjTransTest(A, xc, zc);
  ...
  Copy(wc, yc);
  A.MltAddVector(alphac, SeldonConjTrans, xc, betac, yc);
