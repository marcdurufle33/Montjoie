#ifndef MONTJOIE_FILE_WEDGE_HDIV_OPTIMAL_HP_FIRST_FAMILY_HXX
...
namespace Montjoie
{
  ...
  /*!
    ...
    D_{r+1}(x, y) P_r(z)  x  P_{r-1}(x, y) P_{r+2}(z)
   */
  class WedgeHdivOptimalHpFirstFamily : public WedgeReference<3>
  {
  protected :
...
#define MONTJOIE_FILE_WEDGE_HDIV_OPTIMAL_HP_FIRST_FAMILY_HXX
#endif
