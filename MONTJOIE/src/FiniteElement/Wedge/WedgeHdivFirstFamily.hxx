#ifndef MONTJOIE_FILE_WEDGE_HDIV_FIRST_FAMILY_HXX
...
namespace Montjoie
{
   ...
   */
  class WedgeHdivFirstFamily : public WedgeReference<3>
  {
  protected :
...
#define MONTJOIE_FILE_WEDGE_HDIV_FIRST_FAMILY_HXX
#endif
