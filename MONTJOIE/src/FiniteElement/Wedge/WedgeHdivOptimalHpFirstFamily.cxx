#ifndef MONTJOIE_FILE_WEDGE_HDIV_OPTIMAL_HP_FIRST_FAMILY_CXX

namespace Montjoie
{
  
  //! default constructor
  WedgeHdivOptimalHpFirstFamily::WedgeHdivOptimalHpFirstFamily() : WedgeReference<3>()
  {
  ...
  //! how to number mesh
  void WedgeHdivOptimalHpFirstFamily::ConstructNumberMap(NumberMap& nmap, int dg) const
  {
    ...
    const Matrix<int>& NumQuad2D = GetNumQuad2D();
  ...
  size_t WedgeHdivOptimalHpFirstFamily::GetMemorySize() const
  {
  ...
  void WedgeHdivOptimalHpFirstFamily
			   ...
			   int type_surf_tri, int type_surf_quad, int gauss_z)
  {
    ...
    // type_quad = WedgeQuadrature::QUADRATURE_JACOBI1;    
    ...
    //this->mass_matrix.Write("MhWedDiv"+to_str(this->order)+".dat");
    //this->const_div_matrix.Write("KhWedDiv"+to_str(this->order)+".dat");
  ...
  void WedgeHdivOptimalHpFirstFamily::ConstructFunctions()
  {    
  ...
  */  
  ...
  //! displays details of class WedgeHdivOptimalHpFirstFamily
  ostream& operator <<(ostream& out, const WedgeHdivOptimalHpFirstFamily& e)
  {
...
#define MONTJOIE_FILE_WEDGE_HDIV_OPTIMAL_HP_FIRST_FAMILY_CXX
#endif
