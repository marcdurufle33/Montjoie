#ifndef MONTJOIE_FILE_WEDGE_HCURL_OPTIMAL_FIRST_FAMILY_HXX
...
namespace Montjoie
{
   ...
   */
  class WedgeHcurlOptimalFirstFamily : public WedgeReference<2>
  {
  protected :
...
#define MONTJOIE_FILE_WEDGE_HCURL_OPTIMAL_FIRST_FAMILY_HXX
#endif
