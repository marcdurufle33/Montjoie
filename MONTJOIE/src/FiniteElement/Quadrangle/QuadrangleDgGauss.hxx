#ifndef MONTJOIE_FILE_QUADRANGLE_DG_GAUSS_HXX

namespace Montjoie
{
  
  //! class with nodal finite element with Gauss points and DG formulation
  /*!
    Both interpolation (dofs) and quadrature points are Gauss points,
    while nodal points (for the definition of Geometry for curved elements)
    are Gauss-Lobatto points
   */
  class QuadrangleDgGauss : public QuadrangleGauss
  {
  protected :
    Matrix<Real_wp> ValGauss_Extremity;
    Matrix<Real_wp> dG_GL;
...
#define MONTJOIE_FILE_QUADRANGLE_DG_GAUSS_HXX
#endif
