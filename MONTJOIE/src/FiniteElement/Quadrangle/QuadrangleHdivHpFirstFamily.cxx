#ifndef MONTJOIE_FILE_QUADRANGLE_HDIV_HP_FIRST_FAMILY_CXX

namespace Montjoie
{
  
  //! default constructor
  QuadrangleHdivHpFirstFamily::QuadrangleHdivHpFirstFamily() : QuadrangleReference<3>()
  {
  ...
  void QuadrangleHdivHpFirstFamily::ConstructNumberMap(NumberMap& nmap, int dg) const
  {
  ...
  size_t QuadrangleHdivHpFirstFamily::GetMemorySize() const
  {
  ...
  void QuadrangleHdivHpFirstFamily::
  ...
  void QuadrangleHdivHpFirstFamily::ConstructFunctions()
  {
  ...
  */
  void QuadrangleHdivHpFirstFamily::ComputeDivPhiRef(const R2& point_loc, VectReal_wp& res) const
  {
  ...
  //! displays informations about class QuadrangleHdivHpFirstFamily
...
#define MONTJOIE_FILE_QUADRANGLE_HDIV_HP_FIRST_FAMILY_CXX
#endif
