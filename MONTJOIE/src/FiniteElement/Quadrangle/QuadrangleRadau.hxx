#ifndef MONTJOIE_FILE_QUADRANGLE_RADAU_HXX

namespace Montjoie
{
  
  //! class for nodal finite element with Gauss-Radau points
  class QuadrangleRadau : public QuadrangleLobatto
  {
  protected :
    bool radau_points;
    Globatto<Real_wp> lob_x;
  ...
  public :
    ...
    friend ostream& operator <<(ostream& out, const QuadrangleRadau& e);
  };
    
}

#define MONTJOIE_FILE_QUADRANGLE_RADAU_HXX
#endif
