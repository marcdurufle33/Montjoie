#ifndef MONTJOIE_FILE_PYRAMID_HDIV_OPTIMAL_FIRST_FAMILY_HXX
...
namespace Montjoie
{
   ...
   */
  class PyramidHdivOptimalFirstFamily : public PyramidReference<3>
  {
  protected :
...
#define MONTJOIE_FILE_PYRAMID_HDIV_OPTIMAL_FIRST_FAMILY_HXX
#endif
