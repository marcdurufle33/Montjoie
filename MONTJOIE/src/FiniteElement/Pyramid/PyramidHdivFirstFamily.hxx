#ifndef MONTJOIE_FILE_PYRAMID_HDIV_FIRST_FAMILY_HXX
...
namespace Montjoie
{
   ...
   */
  class PyramidHdivFirstFamily : public PyramidReference<3>
  {
  protected :
...
#define MONTJOIE_FILE_PYRAMID_HDIV_FIRST_FAMILY_HXX
#endif
