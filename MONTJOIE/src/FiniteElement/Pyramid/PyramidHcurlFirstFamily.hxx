#ifndef MONTJOIE_FILE_PYRAMID_HCURL_FIRST_FAMILY_HXX
...
namespace Montjoie
{
   ...
   */
  class PyramidHcurlFirstFamily : public PyramidReference<2>
  {
  public:
    //! regular or non-regular nodal points ?
    int type_basis;
    enum {REGULAR_POINTS, LOBATTO_POINTS, NIGAM_PHILLIPS_2};
...
#define MONTJOIE_FILE_PYRAMID_HCURL_FIRST_FAMILY_HXX
#endif
