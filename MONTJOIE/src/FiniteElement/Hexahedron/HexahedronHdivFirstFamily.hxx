#ifndef MONTJOIE_FILE_HEXAHEDRON_HDIV_FIRST_FAMILY_HXX
...
namespace Montjoie
{
  ...
  /*!
    ...
    with i <= r, j <= r-1, k <= r-1
    Gauss-Lobatto points are used for integration
   */
  class HexahedronHdivFirstFamily : public HexahedronReference<3>
  {
  protected :
...
#define MONTJOIE_FILE_HEXAHEDRON_HDIV_FIRST_FAMILY_HXX
#endif
