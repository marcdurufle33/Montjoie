#ifndef MONTJOIE_FILE_HEXAHEDRON_HDIV_HP_FIRST_FAMILY_HXX
...
namespace Montjoie
{
  ...
  /*!
    ...
    and generate the space Q_{r, r-1, r-1} x Q_{r-1, r, r-1} x Q_{r-1, r-1, r}
    They are based on Jacobi polynomials
    Quadrature rules are Gauss points
   */
  class HexahedronHdivHpFirstFamily : public HexahedronReference<3>
  {
  protected :
...
#define MONTJOIE_FILE_HEXAHEDRON_HDIV_HP_FIRST_FAMILY_HXX
#endif
