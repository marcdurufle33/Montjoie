#ifndef MONTJOIE_FILE_HEXAHEDRON_HCURL_OPTIMAL_HP_FIRST_FAMILY_HXX
...
namespace Montjoie
{
  ...
  /*!
    ...
    and generate the space Q_{r-1, r+1, r+1} x Q_{r+1, r-1, r+1} x Q_{r+1, r+1, r-1}
    They are based on Jacobi polynomials
    Quadrature rules are Gauss points
   */
  class HexahedronHcurlOptimalHpFirstFamily : public HexahedronReference<2>
  {
...
#define MONTJOIE_FILE_HEXAHEDRON_HCURL_OPTIMAL_HP_FIRST_FAMILY_HXX
#endif
