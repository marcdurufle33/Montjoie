...
#include "Helio/Solvers/Helmholtz_axi.hxx"
#include "Helio/Solvers/Helmholtz_axi_inline.cxx"
#include "Helio/Solvers/Helmholtz_axi.cxx"
  ...
  while (!var.last_output_solution)
    {
      ...
      glob_solver.ComputeSolution(source_rhs, x_sol, nature_matrix);
      ...
      MpiAllreduce(var.comm_group_mode, &max_x, xtmp, &x_inf, 1, MPI::MAX);    
#endif
  ...
  if (argc > 1)
    {
      ...
      // probleme harmonique
      EllipticProblem<HELIO_HelmholtzAxisymEquation> Vars;
