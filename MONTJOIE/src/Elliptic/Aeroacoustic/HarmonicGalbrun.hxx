...
namespace Montjoie
{
  ...
  class GalbrunEquation_Base : public GenericEquation<T>
  {
  public :
   ...
   */
  template<class T, class Dim>
  class GalbrunEquationDG_Base : public GenericEquation<T>
  {
  public :
    typedef Dim Dimension;
  ...
  public:
    ...
    Vector<Vector<R_N> > eval_flow, grad_rho0, grad_sigma, grad_p0, grad_c0, grad_gamma, eval_f0;
    ...
    bool compute_source_momentum; //AJOUT NATHAN
