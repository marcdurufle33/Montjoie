...
namespace Montjoie
{
  ...
  SELDON_EXTERN template void FiniteElementInterpolator::
  ComputeLocalProlongation(const Vector<const ElementReference_Dim<Dimension1>* >&, int,
			   const Vector<const ElementReference_Dim<Dimension1>* >&, int, TinyVector<Matrix<Real_wp>, 4>&);
  
  
  SELDON_EXTERN template void FiniteElementInterpolator::
  ComputeLocalProlongationLowOrder(const Vector<const ElementReference_Dim<Dimension2>* >&, int,
				   const Vector<const ElementReference_Dim<Dimension2>* >&, int, TinyVector<Matrix<Real_wp>, 4>&);

  SELDON_EXTERN template void FiniteElementInterpolator::
  ComputeLocalProlongation(const Vector<const ElementReference_Dim<Dimension2>* >&, int,
			   const Vector<const ElementReference_Dim<Dimension2>* >&, int, TinyVector<Matrix<Real_wp>, 4>&);


  SELDON_EXTERN template void FiniteElementInterpolator::
  ComputeLocalProlongationLowOrder(const Vector<const ElementReference_Dim<Dimension3>* >&, int,
				   const Vector<const ElementReference_Dim<Dimension3>* >&, int, TinyVector<Matrix<Real_wp>, 4>&);

  SELDON_EXTERN template void FiniteElementInterpolator::
  ComputeLocalProlongation(const Vector<const ElementReference_Dim<Dimension3>* >&, int,
			   const Vector<const ElementReference_Dim<Dimension3>* >&, int, TinyVector<Matrix<Real_wp>, 4>&);
