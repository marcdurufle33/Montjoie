...
namespace Seldon
{
  ...
  SELDON_EXTERN template void Vector<TinyVector<Montjoie::Complex_wp, 2> >::Resize(size_t);
  SELDON_EXTERN template void Vector<TinyVector<Montjoie::Real_wp, 3> >::Resize(size_t);
  SELDON_EXTERN template void Vector<TinyVector<Montjoie::Complex_wp, 3> >::Resize(size_t);
  ...
  SELDON_EXTERN template void Vector<Montjoie::ElementReference_Dim<Montjoie::Dimension1>* >::Resize(size_t);
  SELDON_EXTERN template void Vector<Montjoie::ElementReference_Dim<Montjoie::Dimension2>* >::Resize(size_t);
  SELDON_EXTERN template void Vector<Montjoie::ElementReference_Dim<Montjoie::Dimension3>* >::Resize(size_t);
  ...
  SELDON_EXTERN template void Vector<Montjoie::ElementReference<Montjoie::Dimension1, 1>* >::Resize(size_t);

  SELDON_EXTERN template void Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension3>* >::Fill(Montjoie::ElementReference_Dim<Montjoie::Dimension3>* const&);
  SELDON_EXTERN template void Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension1>* >::Fill(Montjoie::ElementReference_Dim<Montjoie::Dimension1>* const&);
  SELDON_EXTERN template void Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension2>* >::Fill(Montjoie::ElementReference_Dim<Montjoie::Dimension2>* const&);

  SELDON_EXTERN template Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension1>* >::Array2D(int, int);
  SELDON_EXTERN template Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension2>* >::Array2D(int, int);
  SELDON_EXTERN template Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension3>* >::Array2D(int, int);
  SELDON_EXTERN template Array2D<Matrix<Real_wp> >::Array2D(int, int);

  SELDON_EXTERN template Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension1>* >::Array2D();
  SELDON_EXTERN template Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension2>* >::Array2D();
  SELDON_EXTERN template Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension3>* >::Array2D();
  SELDON_EXTERN template Array2D<Matrix<Real_wp> >::Array2D();
  
  SELDON_EXTERN template void Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension1>* >::Reallocate(int, int);
  SELDON_EXTERN template void Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension2>* >::Reallocate(int, int);
  SELDON_EXTERN template void Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension3>* >::Reallocate(int, int);
  SELDON_EXTERN template void Array2D<Matrix<Real_wp> >::Reallocate(int, int);
  
  SELDON_EXTERN template void Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension1>* >::Clear();
  SELDON_EXTERN template void Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension2>* >::Clear();
  SELDON_EXTERN template void Array2D<Montjoie::ElementReference_Dim<Montjoie::Dimension3>* >::Clear();
  SELDON_EXTERN template void Array2D<Matrix<Real_wp> >::Clear();
  
  SELDON_EXTERN template Array2D<Vector<TinyMatrix<Real_wp, General, 2, 2> > >::Array2D(int, int);
  SELDON_EXTERN template Array2D<Vector<TinyMatrix<Complex_wp, General, 2, 2> > >::Array2D(int, int);

  SELDON_EXTERN template Array2D<Vector<TinyVector<Real_wp, 2> > >::Array2D(int, int);
  SELDON_EXTERN template Array2D<Vector<TinyVector<Complex_wp, 2> > >::Array2D(int, int);

  SELDON_EXTERN template Array2D<Vector<TinyMatrix<Real_wp, General, 3, 3> > >::Array2D(int, int);
  SELDON_EXTERN template Array2D<Vector<TinyMatrix<Complex_wp, General, 3, 3> > >::Array2D(int, int);

  SELDON_EXTERN template Array2D<Vector<TinyVector<Real_wp, 3> > >::Array2D(int, int);
  SELDON_EXTERN template Array2D<Vector<TinyVector<Complex_wp, 3> > >::Array2D(int, int);

  SELDON_EXTERN template Array2D<Vector<Real_wp> >::Array2D(int, int);
  SELDON_EXTERN template Array2D<Vector<Complex_wp> >::Array2D(int, int);

  SELDON_EXTERN template void Array2D<Vector<TinyMatrix<Real_wp, General, 2, 2> > >::Clear();
  SELDON_EXTERN template void Array2D<Vector<TinyMatrix<Complex_wp, General, 2, 2> > >::Clear();

  SELDON_EXTERN template void Array2D<Vector<TinyVector<Real_wp, 2> > >::Clear();
  SELDON_EXTERN template void Array2D<Vector<TinyVector<Complex_wp, 2> > >::Clear();

  SELDON_EXTERN template void Array2D<Vector<TinyMatrix<Real_wp, General, 3, 3> > >::Clear();
  SELDON_EXTERN template void Array2D<Vector<TinyMatrix<Complex_wp, General, 3, 3> > >::Clear();

  SELDON_EXTERN template void Array2D<Vector<TinyVector<Real_wp, 3> > >::Clear();
  SELDON_EXTERN template void Array2D<Vector<TinyVector<Complex_wp, 3> > >::Clear();

  SELDON_EXTERN template void Array2D<Vector<Real_wp> >::Clear();
  SELDON_EXTERN template void Array2D<Vector<Complex_wp> >::Clear();
