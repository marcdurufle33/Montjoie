...
namespace Seldon
{
  ...
  SELDON_EXTERN template void SorVector(const Matrix<Real_wp, General, RowSparse>&, Vector<Complex_wp>&, const Vector<Complex_wp>&, const Real_wp&, int, int);
  ...
  SELDON_EXTERN template void SorVector(const Matrix<Real_wp, General, ArrayRowSparse>&, Vector<Complex_wp>&, const Vector<Complex_wp>&, const Real_wp&, int, int);
  ...
  SELDON_EXTERN template void SorVector(const Matrix<Real_wp, Symmetric, RowSymSparse>&, Vector<Complex_wp>&, const Vector<Complex_wp>&, const Real_wp&, int, int);
  ...
  SELDON_EXTERN template void SorVector(const Matrix<Real_wp, Symmetric, ArrayRowSymSparse>&, Vector<Complex_wp>&, const Vector<Complex_wp>&, const Real_wp&, int, int);
