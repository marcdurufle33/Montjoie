...
namespace Seldon
{
  ...
  SELDON_EXTERN template void MpiGather(const MPI_Comm&, int*, Vector<int64_t>&, int*, int, int);
  ...
  SELDON_EXTERN template void MpiGather(const MPI_Comm&, Vector<int>&, Vector<int64_t>&, Vector<int>&, int, int);
