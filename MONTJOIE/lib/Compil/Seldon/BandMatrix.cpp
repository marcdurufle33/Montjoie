...
namespace Seldon
{
  ...
  SELDON_EXTERN template void Matrix_Band<Real_wp, General, BandedCol>::MltAdd(const Real_wp&, const SeldonTranspose&, const Vector<Real_wp>&, Vector<Real_wp>&) const;
  SELDON_EXTERN template void Matrix_Band<Real_wp, General, BandedCol>::MltAdd(const Complex_wp&, const SeldonTranspose&, const Vector<Complex_wp>&, Vector<Complex_wp>&) const;
  SELDON_EXTERN template void Matrix_Band<Complex_wp, General, BandedCol>::MltAdd(const Complex_wp&, const SeldonTranspose&, const Vector<Complex_wp>&, Vector<Complex_wp>&) const;
