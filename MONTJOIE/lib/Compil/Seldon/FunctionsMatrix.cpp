...
namespace Seldon
{
  ...
  SELDON_EXTERN template void MltAddMatrix(Real_wp const&, Matrix<Real_wp, General, RowMajor> const&, Matrix<Real_wp, General, RowMajor> const&, Real_wp const&, Matrix<Real_wp, Symmetric, RowSymPacked>&);
  
  SELDON_EXTERN template void MltAddMatrix(Complex_wp const&, Matrix<Complex_wp, General, RowMajor> const&, Matrix<Complex_wp, General, RowMajor> const&, Complex_wp const&, Matrix<Complex_wp, Symmetric, RowSymPacked>&);
