...
SRC_ALGEBRA := lib/Compil/Algebra/additional_function.cpp lib/Compil/Algebra/matrix_blockdiagonal.cpp lib/Compil/Algebra/skyline_matrix.cpp lib/Compil/Algebra/tiny_band_matrix.cpp lib/Compil/Algebra/tiny_vector.cpp lib/Compil/Algebra/distributed_block_diag.cpp lib/Compil/Algebra/scalapack.cpp
...
lib/Compil/Algebra/tiny_vector$(MONT_SUFFIX).o : lib/Compil/Algebra/tiny_vector.cpp $(CHESELDON)/vector/Vector.cxx src/Algebra/TinyMatrix.cxx src/Algebra/TinyVector.cxx
	$(VERBOSE)$(CC) -c $(INCLUDE) $(FLAGS_LIB) $< -o $@ $(AGRESSIVE_OPTIM)
...
lib/Compil/Share/common$(MONT_SUFFIX).o : lib/Compil/Share/common.cpp src/Share/MontjoieTypes.cxx src/Share/CommonMontjoie.cxx src/Share/Precision.cxx
	$(VERBOSE)$(CC) -c $(INCLUDE) $(FLAGS_LIB) -DMONTJOIE_SIMPLE_COMPIL $< -o $@ $(AGRESSIVE_OPTIM)
...
# Montjoie library
OBJ_SELDON := $(OBJ_SELDON) $(LIB_ALGEBRA)
OBJ_MONTJOIE :=  $(LIB_SHARE)
...
cleanmontjoie :
	rm -f $(LIB_MONTJOIE) $(LIB_MONTJOIE_STATIC) $(OBJ_MONTJOIE)
